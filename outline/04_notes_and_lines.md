# Notes, Key Lines & Reference Material

## Key Lines & Phrases (Confirmed for the Book)

- **"The truth cannot be found in words. So take this book with a grain of salt."** (Opening lines)
- **"One sees copies. The other sees families."** (Cafeteria wall scene)
...
- **"If you want to keep running forever, I'll be right there by your side. And if you get tired, you can jump on my back."** (Eric to Persefoni on the train — no fixing, no agenda, just presence)
...
- **Démion loves Démion most of all.** Persefoni, though usually first, always has a partner, a peer. Démion considers himself peerless. She keeps reaching for the peer and finding only the reflection.
- **Sheepey** (shee-PAY) — stuffed sheep from Stonehenge gift shop. The opening image. Pure play. The character Persefoni and Kathleen create together. A bit of a drunk, loves to gamble, from Stonehenge. Recurring motif — relic of who she was before.
- **"Oh, that doesn't hurt. You're just tender headed."** (Rosemary braiding young Persefoni's hair — core memory of gaslighting. The first time her experience was overwritten by someone else's narrative. Template for everything that follows.)
...
- The personality Persefoni consumed Alejandro as was never really interested — he was content to her
- Body cam footage of the slippery moment could go viral — feeds cult of personality forming around her

---

## Structural / Craft Notes

- Three layers of peace at the retreat: concentration (day 4), nostalgic (Portland memory), reconciliation (Ho'oponopono) — each deeper
- The Portland memory unfolds in layers: day 4 = the feeling; day 7 = the full experience (deer). Same morning, recovered as perception deepens.
- Confluence first appears through water imagery (grasping/gathering → cups → current → Confluence)
- The Emissary's "waking up" moments: talking to the dispatcher, "what am I gonna lie here forever," choosing not to take the escape path → shows personality isn't killed, it's integrated
- Key scene contrasts:
...
- Psychiatrist and philosopher; 20 years of research
- Right hemisphere = the Master (broad, contextual, connected to living world, generous)
- Left hemisphere = the Emissary (detail-oriented, categorizing, narrating, self-interested)
- The difference lies not in WHAT each does but HOW — two whole, coherent, incompatible ways of experiencing the world
- The Emissary has usurped the Master — happening culturally across Western civilization
...
- Persefoni reads this book before the retreat, recommended by Alejandro

### Vipassana Meditation
- 10-day silent retreat tradition
- Anapana: concentration on breath at the nostrils (first technique taught)
- Noble silence: no talking, no eye contact, no writing
- Schedule: ~10+ hours of meditation per day
- Various retreat centers worldwide; 29 Palms/Joshua Tree area is the setting
...
- Persefoni knew it before the retreat at a surface level; uses it for real directed inward
...
- Persefoni has a custom tarot deck; does readings for followers
