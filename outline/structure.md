...
**POV: Persephone & Rosemary (strict alternation)**
...
- **3.9** — Post-retreat crisis / shaving head / the prayer / the note / Confluence (Persephone POV)
- **3.10** — The 911 call from Rosemary's side (Rosemary POV)
- **3.11** — The naked walk / police confrontation / slippery moment (Persephone POV) ✍️
...
**POV: Persephone & Eric (strict alternation)**
*Eric mirrors her awakening*

- **4.1** — Ometepe Island / arriving at the eco village (Persephone POV)
- **4.2** — Eric and Erica / the tantra workshop / his quiet crisis (Eric POV)
- **4.3** — The proposition game / "Can I tell you the truth?" (Persephone POV)
- **4.4** — Eric and Erica's fight / Erica leaves (Eric POV)
- **4.5** — The Kathleen echo / the pattern repeats and doesn't (Persephone POV)
- **4.6** — Eric's night: the all-night conversation / the beginning (Eric POV)
- **4.7** — San Cristóbal / the relationship becomes real (Persephone POV)
- **4.8** — Eric's story: curiosity as survival / how he sees her (Eric POV)
- **4.9** — Writing "Science and the Cult of Personality" together (Persephone POV)
- **4.10** — Oaxaca / the old man / reality intrudes (Eric POV)
- **4.11** — Second retreat, Washington: Persephone's deepening (Persephone POV)
